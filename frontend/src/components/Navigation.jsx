...
import { Cpu, Eye, Radio, GitCompare, Database } from 'lucide-react';

export const NAVIGATION_ITEMS = [
  { id: 'analysis', label: 'Live Transaction AI', icon: Cpu, tag: 'INFERENCE' },
  { id: 'explainability', label: 'SHAP Explainability', icon: Eye, tag: 'XAI GLASS BOX' },
  { id: 'monitoring', label: 'PaySim Live Stream', icon: Radio, tag: 'REAL-TIME' },
  { id: 'comparison', label: 'Model & Sampling Lab', icon: GitCompare, tag: 'OMNISMOTE' },
  { id: 'dashboard', label: 'Dataset Telemetry', icon: Database, tag: 'PAYSIM DATA' },
];
